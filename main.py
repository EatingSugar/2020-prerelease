...
def choiceandadd(var, choice1, choice2, listpull):
  var = input("Do you want " + choice1 + " or " + choice2 + "?")
  while var != choice1 and var != choice2:
    var = input("Do you want " + choice1 + " or " + str(choice2) + "?")
  
  index = listpull.index(var)
  global pricetotal
  pricetotal += prices[index]
  itemspurchased.append(listpull[index])

simorPAYG = ""
choiceandadd(simorPAYG, "SIM Free", "Pay As You Go", descs)
