...
phonepricetotal = 0
overallphonepricetotal = 0
itemspurchased = []
phonesbought = 0
additionalphones = True

while additionalphones == True: 
  phonepricetotal = 0
  ...
  phonepricetotal += prices[itemindex]
  ...
  phonepricetotal += prices[simindex]
  ...
  phonepricetotal += prices[caseindex]
  ...
  if phonesbought > 0:
    phonepricetotal = phonepricetotal * 0.9
  ...
  if numberofchargers == 0:
    ...
    phonepricetotal += (prices[14] + prices[15])
  else:
    itemspurchased.append(descs[numberofchargers + 13])
    phonepricetotal += prices[numberofchargers + 13]
  ...
  if extraphone == "N":
    ...
    overallphonepricetotal += phonepricetotal
  else:
    overallphonepricetotal += phonepricetotal

print()
print("Total price: $" + str(phonepricetotal))
